...
pair = 'mRNA-PROMPT'
params = np.loadtxt("F:\\courses\\Project\\data\\TFs\\param_matrix_"+pair+".txt",
                    dtype='float', delimiter="\t")

f_f = open("F:\\courses\\Project\\data\\bigWigAverageOverBed\\sum of signal\\sum_GRO_"+pair+"_forward.out", 'r')
f_r = open("F:\\courses\\Project\\data\\bigWigAverageOverBed\\sum of signal\\sum_GRO_"+pair+"_reverse.out", 'r')
